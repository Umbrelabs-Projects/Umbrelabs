...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/theumbrelabs",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/theumbrelabs",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/theumbrelabs",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-[18px] h-[18px]" aria-hidden="true">
            ...
            <div className="mt-8 flex items-center gap-3">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-10 h-10 rounded-full border border-outline-variant flex items-center justify-center text-on-surface-variant hover:text-gold hover:border-gold/50 hover:bg-on-surface/5 transition-all press-scale"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <a href="mailto:contact@umbrelabs.com" className="text-on-surface hover:text-gold transition-colors w-fit break-all">contact@umbrelabs.com</a>
                <a href="tel:+233554317351" className="text-on-surface hover:text-gold transition-colors w-fit">055 431 7351/024 436 1636 </a>
                <span className="text-on-surface-variant">Ghana · Africa</span>
              </nav>
            </div>
          </div>
        </div>
